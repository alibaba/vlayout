...
Please find the latest version(1.0.8 so far) in maven repository. The newest version has been upload to jcenter and MavenCentral, make sure you have added at least one of these repositories.

For gradle:
``` gradle
compile ('com.alibaba.android:vlayout:1.0.8@aar') {
	transitive = true
}
```
